...
#Set up data loaders
train_dataset = load_folder_twostream.ImageFolderDataset(train_dir, transform_ventral=transform_ventral, transform_dorsal=transform_dorsal)
val_dataset = load_folder_twostream.ImageFolderDataset(val_dir, transform_ventral=transform_ventral, transform_dorsal=transform_dorsal)
